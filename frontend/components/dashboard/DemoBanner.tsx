  ...
  return (
    <div
      ...
      className="
        ...
        rounded-lg border border-[hsl(173,57%,55%)]/30
        bg-[hsl(173,57%,55%)]/[0.07]
        px-3 py-2 text-[12px]
      "
    >
      <Sparkles className="w-3.5 h-3.5 text-[hsl(173,57%,34%)] shrink-0" />
      ...
      {onUpload && (
        <button
          ...
          className="
            ...
            font-semibold text-[hsl(173,57%,34%)]
