...
const en: LandingStrings = {
  ...
  pricing: {
    ...
    subtitle: "Start free with one document. Upgrade when you need more. Cancel anytime.",
    ...
    solo: {
      ...
      features: ["1 company workspace", "3 trial balances / month (€1.49 per extra)", "Full 9-section analysis &amp; board report", "P&amp;L, balance sheet, cash flow &amp; ratios", "50 Ask CFO AI chats / month", "Exports &amp; email support"],
    },
    business: {
      ...
      features: ["15 trial balances / month (€0.99 per extra)", "Scanned-PDF ingestion", "Industry benchmarks &amp; peer comparison", "Valuation suite &amp; NAV cascade", "150 Ask CFO AI chats / month", "Priority support"],
    },
    pro: {
...
const ro: LandingStrings = {
  ...
  pricing: {
    ...
    subtitle: "Începe gratuit cu un document. Faci upgrade când ai nevoie de mai mult. Anulezi oricând.",
    ...
    solo: {
      ...
      features: ["1 spațiu de lucru", "3 balanțe de verificare / lună (1,49 € per extra)", "Analiza completă în 9 secțiuni &amp; raport de board", "P&amp;L, bilanț, cash flow &amp; indicatori", "50 de conversații Ask CFO AI / lună", "Exporturi &amp; suport pe e-mail"],
    },
    business: {
      ...
      features: ["15 balanțe de verificare / lună (0,99 € per extra)", "Ingestie PDF scanat", "Benchmark-uri de industrie &amp; comparație cu companii similare", "Suită de evaluare &amp; cascadă NAV", "150 de conversații Ask CFO AI / lună", "Suport prioritar"],
    },
    pro: {
