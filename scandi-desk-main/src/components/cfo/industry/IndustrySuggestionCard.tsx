  ...
  return (
    ...
    >
      ...
      <div className="mt-1.5 font-medium text-ink inline-flex items-center gap-2">
        ...
        {isSelected && (
          <CheckCircle2 size={14} strokeWidth={2.2} className="text-emerald-600" aria-label="Currently selected" />
        )}
        {isPrimary && locked && (
          <span className="inline-flex items-center gap-1 text-[10px] text-blue-700 bg-blue-100/70 rounded px-1.5 py-0.5">
            <Lock size={9} /> Locked
          </span>
        )}
      </div>
